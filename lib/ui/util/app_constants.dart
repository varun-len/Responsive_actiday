...
String str_activeLifestyle ="Active Lifestyle";
String str_getActiveEveryday="Get active every day Try new things \nFind new classes";
String str_categories ="Catagories";
String str_topClasees="Top Classes";
String str_viewAll="View All";
String str_royalPeaceSpa ="Royal Peace Spa";
String str_relaxandrejuvenate ="Relax and rejuvenate with the traditional Thai dry therapy Relax and rejuvenate with the";
String str_Logout="Logout ";
String str_Login="Login";
String str_noFav="No Favourites";
String str_beFit="Be Fit";
String str_carouselSubtitle="Experts define the physical fitness as one's ability \n to execute daily activity with optimal";
String str_Upcoming="Upcoming";
String str_Past="Past";
String str_Welocme="Welcome";
String str_Booking="Booking";
String str_credit="credit";
String str_searchString="yoga, pilates, massage";
String str_AppbarTitle="Abu Dhabi,UAE";
String str_LogoutPermission="Do You want to LogOut";
String str_wavinghand="👋";
String str_Yes="Yes";
String str_No="No";
